...
const Plaint = db.define("Plaint", {
    id: { type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true },
    plaint_date: { type: DataTypes.DATEONLY, allowNull: false, defaultValue: DataTypes.NOW },
    ...
    plaint_step: { type: DataTypes.STRING(20), allowNull: false, defaultValue: "STEP" },
    ...
    dudgement: { type: DataTypes.TEXT, allowNull: true },
    finished: { type: DataTypes.BOOLEAN, allowNull: false, defaultValue: false },
    createdAt: { type: DataTypes.DATE, allowNull: true, defaultValue: DataTypes.NOW },
    updatedAt: { type: DataTypes.DATE, allowNull: true, defaultValue: DataTypes.NOW }
}, { tableName: "plaints", timestamps: true });

Plaint.belongsTo(LegalCase, { foreignKey: "case_id" });
LegalCase.hasMany(Plaint, { foreignKey: "case_id" });
Plaint.belongsTo(Customer, { foreignKey: "customer_id" });
Customer.hasMany(Plaint, { foreignKey: "customer_id" });

module.exports = Plaint;
